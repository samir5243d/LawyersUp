...
# with center_col:
#     st.markdown("<h1 style='text-align: center;'>⚖️ Lawyer's Up</h1>", unsafe_allow_html=True)
#     st.markdown("<p style='text-align: center; margin-top: -15px; color: #666;'>Minimal AI Legal Assistant Prototype</p>", unsafe_allow_html=True)
#     st.write("")
    
#     selected_language = st.radio("Language / भाषा", ["English", "Hindi", "Marathi"], horizontal=True, label_visibility="collapsed")
#     st.write("")
    
#     user_input = st.text_area("✍️ Describe your problem:", height=150, placeholder="E.g., I was defrauded of money online by a fake website...", label_visibility="collapsed")
#     st.write("")
    
#     get_help_btn = st.button("✨ Get Help", use_container_width=True, type="primary")
...
#                 Use context and keywords to determine the category. 
...
#                             st.session_state.category = fallback_cat
...
#     with center_col:
#         st.write("") # Spacing
#         with st.container(border=True): # Clean card format
#             status_color = "🟢" if st.session_state.category not in ["Not a Legal Issue", "Unknown Category"] else "🟠"
#             st.markdown(f"#### {status_color} Analysis Complete")
#             st.caption(f"**Category:** {st.session_state.category} &nbsp;|&nbsp; **Authority:** {st.session_state.get('recommended_authority', '')}")
#             st.divider()
#             st.markdown(st.session_state.llm_response)

#streamlit run "Streamlit\main9A.py"
#Fixing copy button + slidebar
